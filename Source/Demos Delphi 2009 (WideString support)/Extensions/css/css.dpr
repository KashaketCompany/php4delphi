...
{$IFDEF PHP510}
procedure delphi_css (ht : integer; return_value : pzval;  return_value_ptr : pointer; this_ptr : pzval;
...
begin
  ...
  BodyString := AnsiString(str);
  php_body_write(PAnsiChar(BodyString), Length(BodyString), TSRMLS_DC);
end;
