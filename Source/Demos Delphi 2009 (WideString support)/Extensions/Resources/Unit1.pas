...
procedure Tres_module.PHPExtensionModuleInit(Sender: TObject;
  TSRMLS_DC: Pointer);
begin
  le_myresource := zend_register_list_destructors_ex(@my_destructor_handler, nil, PAnsiChar(le_myresource_name), Application.ModuleNumber);
end;
